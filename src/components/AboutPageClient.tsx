  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {agents.map((agent, i) => {
            const isComingSoon = typeof agent === 'object' && agent.comingSoon;
            ...
            <ScrollReveal key={label} delay={i * 0.06}>
              <motion.div
                ...
                style={{
                  ...
                  padding: "16px 20px",
                  borderRadius: 14,
                  backgroundColor: isComingSoon ? "#0A0A0A" : "#FFFDF5",
                  border: isComingSoon ? "1.5px solid rgba(243,216,64,0.15)" : "1.5px solid rgba(243,216,64,0.15)",
                  cursor: "default",
              ...
              >
                <div
                  style={{
                    ...
                    height: 10,
                    borderRadius: "50%",
                    backgroundColor: isComingSoon ? "rgba(243,216,64,0.4)" : YELLOW,
                    minWidth: 10,
                    boxShadow: isComingSoon ? "none" : "0 0 8px rgba(243,216,64,0.3)",
                  }}
                />
                <span
                  style={{
