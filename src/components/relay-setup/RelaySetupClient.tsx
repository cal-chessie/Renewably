  ...
  return <main id="main-content" className={styles.shell}>
    ...
    <div className={styles.layout}>
      <aside className={styles.sidebar}>
        ...
        <div className={styles.progressSummary}><div className={styles.progressTrack}><i style={{ width: `${progress}%` }} /></div><span>{completeCount === 0 ? 'Start with what you know' : `${progress}% of your setup captured`}</span></div>
