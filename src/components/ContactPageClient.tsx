              ...
              <ScrollReveal>
                <div>
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      <label htmlFor="service" className="block text-sm font-medium text-[#1A1A1A] mb-2">Service Interested In</label>
                    ...
                    <button type="submit"
                      className="w-full sm:w-auto px-8 py-4 bg-[#1A1A1A] hover:bg-[#374151] text-white font-semibold rounded-full transition-all duration-300 shadow-md hover:shadow-lg">
                      Send Message
                    </button>
                  </form>
                </div>
