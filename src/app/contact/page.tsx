...
const contactFaqs = [
  ...
  { q: "How much does it cost?", a: "Monthly plans start at EUR 1,000. You start with the two agents that move the needle first, then grow to the full team as your operation proves out and strengthens. Pricing scales with the number of agents deployed, up to EUR 1,500. There is a one-time setup fee. You bring your own AI API keys and pay model providers directly, typically EUR 50-200 per month. No markup from us." },
