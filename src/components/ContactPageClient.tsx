      ...
      <main className="pt-20">
        ...
        <section className="bg-[#F3D840] py-20 md:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <ScrollReveal>
              <p className="text-[#895A18] font-semibold text-sm tracking-wider uppercase mb-3">Contact Us</p>
                  ...
                  <form className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input type="text" id="firstName" name="firstName" required
                          className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#895A18] focus:ring-2 focus:ring-[#895A18]/20 transition-colors outline-none" />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <select id="service" name="service"
                        className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#895A18] focus:ring-2 focus:ring-[#895A18]/20 transition-colors outline-none bg-white">
                    ...
                    <div>
                      ...
                      <textarea id="message" name="message" rows={5} required
                        className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#895A18] focus:ring-2 focus:ring-[#895A18]/20 transition-colors outline-none resize-y" />
                    </div>
                    <button type="submit"
                      className="w-full sm:w-auto px-8 py-4 bg-[#895A18] hover:bg-[#6B4510] text-white font-semibold rounded-full transition-all duration-300 shadow-md hover:shadow-lg">
                      Send Message
                    </button>
                  </form>
                </div>
              ...
              <ScrollReveal direction="right" delay={0.2}>
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4">
                        <div className="w-10 h-10 rounded-lg bg-[#F3D840] flex items-center justify-center shrink-0">
                          <svg className="w-5 h-5 text-[#895A18]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                        </div>
                        <div>
                          <p className="font-semibold text-[#333333]">Phone</p>
                          <a href="tel:+353873958424" className="text-[#895A18] hover:text-[#6B4510]">+353 873958424</a>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        <div className="w-10 h-10 rounded-lg bg-[#F3D840] flex items-center justify-center shrink-0">
                          <svg className="w-5 h-5 text-[#895A18]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                        </div>
                        <div>
                          <p className="font-semibold text-[#333333]">Email</p>
                          <a href="mailto:cal@renewably.ie" className="text-[#895A18] hover:text-[#6B4510]">cal@renewably.ie</a>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        <div className="w-10 h-10 rounded-lg bg-[#F3D840] flex items-center justify-center shrink-0">
                  ...
                  <div className="p-6 rounded-xl bg-[#F3D840]/10 border border-[#F3D840]">
                    <h3 className="font-semibold text-[#895A18] mb-2">Free Strategy Call</h3>
