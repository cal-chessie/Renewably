...
function CalendarView({
  ...
  return (
    <Card style={{ backgroundColor: "#1A1A1A", border: "1px solid #2A2A2A" }} className="border-0 shadow-sm">
      ...
      <CardContent>
        {/* Day names */}
        <div className="crm-calendar-day-names grid grid-cols-7 gap-px rounded-t-lg overflow-hidden" style={{ border: '1px solid #2A2A2A' }}>
          {dayNames.map((name) => (
            <div key={name} style={{ color: '#A0A0A0', backgroundColor: '#141414', padding: '8px 0', textAlign: 'center', fontSize: 12, fontWeight: 600, textTransform: 'uppercase' }}>
              {name}
            </div>
          ))}
        </div>
        ...
        {/* Calendar grid */}
        <div className="crm-calendar-grid grid grid-cols-7 gap-px rounded-b-lg overflow-hidden" style={{ backgroundColor: '#222222', borderLeft: '1px solid #2A2A2A', borderBottom: '1px solid #2A2A2A', borderRight: '1px solid #2A2A2A' }}>
          {days.map((date, idx) => {
            if (!date) {
              return <div key={'empty-' + idx} style={{ backgroundColor: '#1A1A1A', minHeight: 60 }} />
            }
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '4px 6px',
                  textAlign: 'left',
                  background: isSelected ? 'rgba(243, 216, 64, 0.1)' : 'transparent',
                  border: isSelected ? '2px solid #F3D840' : '2px solid transparent',
                  borderRadius: 0,
                  cursor: 'pointer',
                  position: 'relative',
                  width: '100%',
              ...
              >
                <span
                  style={{
                    ...
                    background: isToday ? '#F3D840' : 'transparent',
                    color: isToday ? '#374151' : '#E0E0E0',
                  }}
                >
                  {date.getDate()}
                </span>

                <div style={{ marginTop: 2, overflow: 'hidden', maxHeight: 70 }}>
                  {dayMeetings.slice(0, 3).map((meeting) => {
                    ...
                    return (
                      ...
                      >
                        <span style={{ flexShrink: 0 }}>{typeConfig.icon}</span>
                        <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{meeting.title}</span>
                      </motion.div>
                    )
                  })}
                  {dayMeetings.length > 3 && (
                    <div style={{ fontSize: 10, color: '#A0A0A0', paddingLeft: 4, fontWeight: 500 }}>
                ...
                >
                  <Plus className="h-4 w-4 rounded-full shadow-sm p-0.5" style={{ color: '#F3D840', background: '#1A1A1A' }} />
                </div>
              </button>
            )
          })}
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="bg-[#F3D840] hover:bg-[#E5C832] text-[#374151] font-semibold"
          >
