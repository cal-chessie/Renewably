...
import {
  ...
  Target, Users, Clock, AlertTriangle,
...
export function ReportsCharts({ data, dateRange, setDateRange, handleExport, saveDialogOpen, setSaveDialogOpen, reportName, setReportName, reportType, setReportType, handleSaveReport }: ReportsChartsProps) {
  return (
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="text-sm text-[#A0A0A0]">Loading charts...</p>
      </div>
    </div>
  )
}
