...
const TRIGGER_TYPES = [
  { value: 'deal_stage_change', label: 'Deal Stage Change', icon: ArrowRight, color: 'text-blue-500', bgStyle: { backgroundColor: 'rgba(59,130,246,0.12)' } },
  { value: 'deal_created', label: 'Deal Created', icon: Target, color: 'text-blue-600', bgStyle: { backgroundColor: 'rgba(59,130,246,0.12)' } },
  { value: 'new_contact', label: 'New Contact', icon: Bot, color: 'text-green-500', bgStyle: { backgroundColor: 'rgba(16,185,129,0.12)' } },
  { value: 'contact_inactive', label: 'Contact Inactive', icon: Clock, color: 'text-orange-500', bgStyle: { backgroundColor: 'rgba(249,115,22,0.12)' } },
  { value: 'task_overdue', label: 'Task Overdue', icon: AlertCircle, color: 'text-red-500', bgStyle: { backgroundColor: 'rgba(239,68,68,0.12)' } },
  { value: 'task_completed', label: 'Task Completed', icon: ClipboardCheck, color: 'text-emerald-500', bgStyle: { backgroundColor: 'rgba(16,185,129,0.12)' } },
  { value: 'proposal_status_change', label: 'Proposal Status Change', icon: Workflow, color: 'text-purple-500', bgStyle: { backgroundColor: 'rgba(168,85,247,0.12)' } },
  { value: 'meeting_created', label: 'Meeting Created', icon: CalendarDays, color: 'text-sky-500', bgStyle: { backgroundColor: 'rgba(14,165,233,0.12)' } },
  { value: 'meeting_completed', label: 'Meeting Completed', icon: Calendar, color: 'text-teal-500', bgStyle: { backgroundColor: 'rgba(20,184,166,0.12)' } },
  { value: 'meeting_cancelled', label: 'Meeting Cancelled', icon: XCircle, color: 'text-rose-500', bgStyle: { backgroundColor: 'rgba(244,63,94,0.12)' } },
  { value: 'invoice_created', label: 'Invoice Created', icon: FileText, color: 'text-amber-500', bgStyle: { backgroundColor: 'rgba(245,158,11,0.12)' } },
  { value: 'invoice_overdue', label: 'Invoice Overdue', icon: CreditCard, color: 'text-red-600', bgStyle: { backgroundColor: 'rgba(239,68,68,0.12)' } },
  { value: 'payment_received', label: 'Payment Received', icon: Banknote, color: 'text-emerald-600', bgStyle: { backgroundColor: 'rgba(16,185,129,0.12)' } },
] as const
...
function StatusBadge({ status }: { status: string }) {
  if (status === 'success') {
    return (
      <Badge variant="outline" className="text-green-400 border-green-800 gap-1 text-xs font-medium" style={{ backgroundColor: 'rgba(16,185,129,0.12)' }}>
  ...
  if (status === 'failed') {
    return (
      <Badge variant="outline" className="text-red-400 border-red-800 gap-1 text-xs font-medium" style={{ backgroundColor: 'rgba(239,68,68,0.12)' }}>
...
function RuleCard({
  ...
  return (
    ...
    >
      <Card className={`border transition-all duration-200 ${rule.isActive ? 'border-[#2A2A2A] shadow-sm' : 'border-[#2A2A2A] opacity-70'}`} style={{ backgroundColor: '#1A1A1A' }}>
        <CardContent className="p-0">
          ...
          <div className="flex items-center gap-3 p-4">
            ...
            {/* Trigger icon */}
            <div className="h-9 w-9 rounded-lg flex items-center justify-center shrink-0" style={triggerInfo?.bgStyle || { backgroundColor: '#1A1A1A' }}>
...
function TriggerBuilder({
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        <div className="h-8 w-8 rounded-lg flex items-center justify-center" style={triggerInfo?.bgStyle || { backgroundColor: '#1A1A1A' }}>
  ...
  const modules = useMemo(() => [
    {
      ...
      color: 'text-blue-500',
      bgStyle: { backgroundColor: 'rgba(59,130,246,0.12)' },
    },
    {
      name: 'Contacts',
      icon: Users,
    ...
    },
    {
      ...
      bgStyle: { backgroundColor: 'rgba(249,115,22,0.12)' },
    },
    {
      name: 'Proposals',
      icon: FileText,
      ...
      bgStyle: { backgroundColor: 'rgba(168,85,247,0.12)' },
    },
    {
      name: 'Meetings',
      icon: CalendarDays,
      ...
      color: 'text-sky-500',
      bgStyle: { backgroundColor: 'rgba(14,165,233,0.12)' },
    },
    {
      name: 'Invoices',
      icon: CreditCard,
      ...
      bgStyle: { backgroundColor: 'rgba(245,158,11,0.12)' },
    },
    {
      name: 'Payments',
      icon: Banknote,
      ...
      <div className="grid grid-cols-4 sm:grid-cols-7 gap-2">
        {coverage.map((mod) => (
          <div
            ...
            style={{ backgroundColor: mod.covered ? 'rgba(16,185,129,0.08)' : '#0A0A0A' }}
          >
            <div className="h-8 w-8 rounded-lg flex items-center justify-center" style={mod.covered ? mod.bgStyle : { backgroundColor: '#222222' }}>
...
export default function WorkflowsPageContent() {
  ...
  return (
    <div className="space-y-5">
      ...
      >
        <Card className="border-[#2A2A2A]" style={{ backgroundColor: '#1A1A1A' }}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgba(16,185,129,0.12)' }}>
        ...
        <Card className="border-[#2A2A2A]" style={{ backgroundColor: '#1A1A1A' }}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgba(59,130,246,0.12)' }}>
