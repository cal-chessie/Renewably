...
export const metadata: Metadata = {
  ...
  description: "Explore Renewably's 8 AI agents: grants management, ESB applications, customer support, logistics, operations, QA, and reporting: purpose-built for Irish solar installers.",
