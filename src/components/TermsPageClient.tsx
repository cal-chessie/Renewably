            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 48 }}>
              ...
              <div>
                ...
                <ul style={{ color: "#535353", fontSize: 15, lineHeight: 1.8, paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <li><strong style={{ color: "#1A1A1A" }}>Your data:</strong> All business data you input into the platform (customer information, job details, and communications) remains your property. You retain full ownership at all times.</li>
              ...
              <div>
                ...
                <ul style={{ color: "#535353", fontSize: 15, lineHeight: 1.8, paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <li>Renewably is not liable for any loss resulting from AI-generated outputs, including but not limited to rejected grant applications, delayed grid connections, or customer complaints.</li>
